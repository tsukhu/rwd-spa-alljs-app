...
db.open(function(err, db) {
    if(!err) {
        ...
        db.collection('destinations', {strict:true}, function(err, collection) {
			if (err) {
...
exports.addDestination = function(req, res) {
    ...
    db.collection('destinations', function(err, collection) {
        collection.insert(destination, {safe:true}, function(err, result) {
            if (err) {
...
exports.updateDestination = function(req, res) {
    ...
    db.collection('destinations', function(err, collection) {
        collection.update({'_id':new BSON.ObjectID(id)}, destination, {safe:true}, function(err, result) {
            if (err) {
...
var populateDB = function() {
    ...
    db.collection('destinations', function(err, collection) {
        collection.insert(destinations, {safe:true}, function(err, result) {});
    });
