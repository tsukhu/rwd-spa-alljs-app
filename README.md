...
5) Group By view of all India Destinations grouped by India Region and State.Thanks to a blog by Ben Nadel covering how to implement groupBy in AngularJS using nested ngRepeat<br>
